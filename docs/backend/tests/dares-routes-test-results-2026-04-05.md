...
&#x20;   √ deve retornar 401 quando o token não for informado (527 ms)

&#x20;   √ deve retornar 401 quando o token estiver mal formatado (16 ms)

&#x20;   √ deve retornar 401 quando o token for inválido (14 ms)

&#x20;   √ deve criar um dare real no banco para usuário autenticado com targetUserId persistido (411 ms)

&#x20;   √ deve criar um dare com maxAttempts e expiresAt customizados (247 ms)

&#x20;   √ deve retornar 400 quando o targetUserId não for informado (115 ms)

&#x20;   √ deve retornar 400 quando o conteúdo não for informado (196 ms)

&#x20;   √ deve retornar 400 quando maxAttempts for inválido (199 ms)

&#x20;   √ deve retornar 400 quando expiresAt for inválido (205 ms)



&#x20; DELETE /dares/:id

&#x20;   √ deve retornar 401 quando o token não for informado (136 ms)

&#x20;   √ deve retornar 401 quando o token estiver mal formatado (16 ms)

&#x20;   √ deve retornar 401 quando o token for inválido (16 ms)

&#x20;   √ deve deletar um dare do próprio autor (300 ms)

&#x20;   √ deve retornar 400 quando o dare não existir (162 ms)

&#x20;   √ deve retornar 400 quando o usuário tentar deletar dare de outro autor (289 ms)
