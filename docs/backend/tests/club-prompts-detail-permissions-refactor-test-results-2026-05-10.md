...
PASS tests/club-prompts-detail.routes.test.ts (7.247 s)
  GET /clubs/:id/prompts/:promptId detail
    √ retorna 401 sem token (396 ms)
    √ retorna detalhe completo do prompt para membro ativo (627 ms)
    √ inclui respostas existentes e estado do visualizador (428 ms)
    √ calcula permissoes de detalhe para autor e moderador (374 ms)
    √ retorna 404 para prompt inexistente ou de outro clube (503 ms)
    √ bloqueia usuario sem acesso em clube privado (263 ms)

Test Suites: 1 passed, 1 total
Tests:       6 passed, 6 total
Snapshots:   0 total
Time:        7.477 s, estimated 10 s
...
O endpoint de detalhe preserva o contrato esperado para prompts de clube e as regras de acesso do dominio. A resposta continua diferenciando corretamente estado do visualizador, relacao do prompt com o clube solicitado e disponibilidade de respostas vinculadas.
