...
function makeCreateGroupState(
  ...
  return {
    ...
    pickCoverFromCamera: jest.fn(),
    pickCoverFromGallery: jest.fn(),
    removeAvatarDraft: jest.fn(),
    removeCoverDraft: jest.fn(),
    clearMediaErrorMessage: jest.fn(),
